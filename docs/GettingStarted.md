...
> This article will lead you to create [modernx](https://github.com/perlinson/modernx) app quickly, and learn all new concepts.
...
After installed, you can check the version with `modernx -v`, and view help info with `modernx -h`.
...
After designing the model, we begin to write the component. We recommend organizing the Component with [stateless functions](https://facebook.github.io/react/docs/reusable-components.html#stateless-functions) because we don't need state almost at all in modernx architecture.
...
There is a concept called `Subscription` from modernx, which is from [elm 0.17](http://elm-lang.org/blog/farewell-to-frp).
...
Next, you can view [modernx official library](https://github.com/perlinson/modernx) for more information.
